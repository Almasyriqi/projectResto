    ...
    ?>
      ...
      <div class="alert alert-orange alert-block">
        <center>
          ...
          Di Sistem Pelayanan R-Dish Restaurant.
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; M. Syifa'ul & M. Fauzan | Kelas TI-2G |
								Praktikum Design Pemrograman Web <a href="#">by R-corp</a> </div>
</div>
